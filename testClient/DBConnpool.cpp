...
const char *DBidentify="tcp://121.49.97.136:3306";
//const char *DBidentify="tcp://222.197.180.140:3306";
...
ConnPool *ConnPool::GetInstance() {
    ...
    if(connPool == NULL)
    {
        connPool = new ConnPool(DBidentify,DBuser,DBpasswd,2);
    }
    return connPool;
}
